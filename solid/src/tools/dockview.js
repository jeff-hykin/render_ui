...
// deno:https://esm.sh/dockview-core@4.9.0/denonext/dockview-core.development.mjs
...
var GroupDragHandler = class extends DragHandler {
  ...
  getData(dragEvent) {
    ...
    const style = globalThis.getComputedStyle(this.el);
...
var DockviewGroupPanelApiImpl = class extends GridviewPanelApiImpl {
  ...
  getWindow() {
    return this.location.type === "popout" ? this.location.getWindow() : globalThis;
  }
  moveTo(options) {
    var _a, _b, _c, _d;
    if (!this._group) {
...
var DockviewPanelModel = class {
  ...
  createTabRenderer(tabLocation) {
    ...
    if (this._params) {
      cmp.init(Object.assign(Object.assign({}, this._params), {
        tabLocation
      }));
    }
  ...
  init(params) {
    ...
    this.tab.init(Object.assign(Object.assign({}, params), {
      tabLocation: "header"
    }));
  }
  layout(width, height) {
...
var Overlay = class _Overlay extends CompositeDisposable {
  ...
  setupDrag(dragTarget, options = {
    ...
    const track = () => {
      ...
      }, addDisposableListener(globalThis, "pointermove", (e) => {
        const containerRect = this.options.container.getBoundingClientRect();
      ...
      }), addDisposableListener(globalThis, "pointerup", () => {
  ...
  setupResize(direction) {
    ...
    this.addDisposables(move, addDisposableListener(resizeHandleElement, "pointerdown", (e) => {
      ...
      const iframes = disableIframePointEvents();
      move.value = new CompositeDisposable(addDisposableListener(globalThis, "pointermove", (e2) => {
        const containerRect = this.options.container.getBoundingClientRect();
        const overlayRect = this._element.getBoundingClientRect();
        ...
        let width = void 0;
        const moveTop = () => {
          top = clamp(y, -Number.MAX_VALUE, startPosition.originalY + startPosition.originalHeight > containerRect.height ? this.getMinimumHeight(containerRect.height) : Math.max(0, startPosition.originalY + startPosition.originalHeight - _Overlay.MINIMUM_HEIGHT));
        ...
        const moveBottom = () => {
          ...
          height = clamp(y - top, top < 0 && typeof this.options.minimumInViewportHeight === "number" ? -top + this.options.minimumInViewportHeight : _Overlay.MINIMUM_HEIGHT, Number.MAX_VALUE);
          bottom = containerRect.height - top - height;
        };
        const moveLeft = () => {
          left = clamp(x, -Number.MAX_VALUE, startPosition.originalX + startPosition.originalWidth > containerRect.width ? this.getMinimumWidth(containerRect.width) : Math.max(0, startPosition.originalX + startPosition.originalWidth - _Overlay.MINIMUM_WIDTH));
        ...
        const moveRight = () => {
          ...
          width = clamp(x - left, left < 0 && typeof this.options.minimumInViewportWidth === "number" ? -left + this.options.minimumInViewportWidth : _Overlay.MINIMUM_WIDTH, Number.MAX_VALUE);
          right = containerRect.width - left - width;
        };
        switch (direction) {
          case "top":
...
var DEFAULT_FLOATING_GROUP_POSITION = {
  left: 100,
  top: 100,
  width: 300,
  height: 300
...
var PopoutWindow = class extends CompositeDisposable {
  ...
  open() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const externalWindow = globalThis.open(url, this.target, features);
      if (!externalWindow) {
        return null;
      }
      const disposable = new CompositeDisposable();
      ...
      }), addDisposableListener(globalThis, "beforeunload", () => {
        this.close();
      }));
      ...
      return new Promise((resolve, reject) => {
        ...
        externalWindow.addEventListener("load", () => {
          try {
            ...
            addStyles(externalDocument, globalThis.document.styleSheets);
...
var PopupService = class extends CompositeDisposable {
  ...
  openPopover(element, position) {
    ...
    this._activeDisposable.value = new CompositeDisposable(addDisposableListener(globalThis, "pointerdown", (event) => {
      var _a2;
  ...
  addPopoutGroup(itemToPopout, options) {
    ...
    const _window = new PopoutWindow(
      ...
      theme !== null && theme !== void 0 ? theme : "",
      {
        ...
        left: globalThis.screenX + box.left,
        top: globalThis.screenY + box.top,
        width: box.width,
        height: box.height,
...
var GridviewComponent = class extends BaseGrid {
  ...
  addPanel(options) {
    var _a, _b, _c, _d;
    let relativeLocation = (_a = options.location) !== null && _a !== void 0 ? _a : [
      0
    ];
...
// deno:https://esm.sh/react@19.2.0/denonext/react.development.mjs
var react_development_exports = {};
__export(react_development_exports, {
  Activity: () => Activity,
  Children: () => Children,
  Component: () => Component,
  Fragment: () => Fragment,
  ...
  "node_modules/react/cjs/react.development.js"(exports, module) {
    ...
    (function() {
      ...
      var didWarnAboutMaps = false, userProvidedKeyEscapeRegex = /\/+/g, reportGlobalError = "function" === typeof reportError ? reportError : function(error) {
        ...
        } else if ("object" === typeof __Process$ && "function" === typeof __Process$.emit) {
          __Process$.emit("uncaughtException", error);
          return;
        }
        console.error(error);
...
var cjsm = __toESM(require_react());
var { Activity, Children, Component, Fragment, Profiler, PureComponent, StrictMode, Suspense, __CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE, __COMPILER_RUNTIME, act, cache, cacheSignal, captureOwnerStack, cloneElement, createContext, createElement, createRef, forwardRef, isValidElement, lazy, memo, startTransition, unstable_useCacheRefresh, use, useActionState, useCallback, useContext, useDebugValue, useDeferredValue, useEffect, useEffectEvent, useId, useImperativeHandle, useInsertionEffect, useLayoutEffect, useMemo, useOptimistic, useReducer, useRef, useState, useSyncExternalStore, useTransition, version } = cjsm;
var endpoint_default = cjsm.default ?? cjsm;

// deno:https://esm.sh/react-dom@19.2.0/denonext/react-dom.development.mjs
var require2 = (n) => {
  ...
  switch (n) {
    case "react":
      return e(react_development_exports);
    default:
...
var require_react_dom_development = __commonJS2({
...
var require_react_dom = __commonJS2({
...
var cjsm2 = __toESM2(require_react_dom());
var { __DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE, createPortal, flushSync, preconnect, prefetchDNS, preinit, preinitModule, preload, preloadModule, requestFormReset, unstable_batchedUpdates, useFormState, useFormStatus, version: version2 } = cjsm2;
var endpoint_default2 = cjsm2.default ?? cjsm2;

// deno:https://esm.sh/dockview@4.9.0/denonext/dockview.development.mjs
var ReactComponentBridge = (props, ref) => {
  const [_, triggerRender] = endpoint_default.useState();
  const _props = endpoint_default.useRef(props.componentProps);
  endpoint_default.useImperativeHandle(ref, () => ({
    update: (componentProps) => {
      _props.current = Object.assign(Object.assign({}, _props.current), componentProps);
      triggerRender(Date.now());
    }
  }), []);
  return endpoint_default.createElement(props.component, _props.current);
};
...
var ReactPartContext = endpoint_default.createContext({});
var ReactPart = class {
  ...
  createPortal() {
    ...
    const bridgeComponent = endpoint_default.createElement(endpoint_default.forwardRef(ReactComponentBridge), {
      component: this.component,
    ...
    const node = this.context ? endpoint_default.createElement(ReactPartContext.Provider, {
      value: this.context
    }, bridgeComponent) : bridgeComponent;
    const portal = endpoint_default2.createPortal(node, this.parent, uniquePortalKeyGenerator.next());
    this.ref = {
      portal,
...
var usePortalsLifecycle = () => {
  const [portals, setPortals] = endpoint_default.useState([]);
  endpoint_default.useDebugValue(`Portal count: ${portals.length}`);
  const addPortal = endpoint_default.useCallback((portal) => {
...
var ReactPanelContentPart = class {
  ...
  update(event) {
    var _a;
    (_a = this.part) === null || _a === void 0 ? void 0 : _a.update({
      params: event.params
    });
  }
  layout(_width, _height) {
...
var DockviewReact = endpoint_default.forwardRef((props, ref) => {
  const domRef = endpoint_default.useRef(null);
  const dockviewRef = endpoint_default.useRef();
  const [portals, addPortal] = usePortalsLifecycle();
  endpoint_default.useImperativeHandle(ref, () => domRef.current, []);
  const prevProps = endpoint_default.useRef({});
  endpoint_default.useEffect(() => {
    const changes = {};
  ...
  return endpoint_default.createElement("div", {
    style: {
      height: "100%",
      width: "100%"
    },
...
var CloseButton = () => endpoint_default.createElement("svg", {
  height: "11",
  width: "11",
  viewBox: "0 0 28 28",
  "aria-hidden": "false",
  focusable: false,
  className: "dv-svg"
}, endpoint_default.createElement("path", {
...
function useTitle(api) {
  const [title, setTitle] = endpoint_default.useState(api.title);
  endpoint_default.useEffect(() => {
...
var DockviewDefaultTab = (_a) => {
  var { api, containerApi: _containerApi, params: _params, hideClose, closeActionOverride, onPointerDown, onPointerUp, onPointerLeave, tabLocation } = _a, rest = __rest(_a, [
    "api",
    "containerApi",
    "params",
    "hideClose",
  ...
  const isMiddleMouseButton = endpoint_default.useRef(false);
  const onClose = endpoint_default.useCallback((event) => {
    event.preventDefault();
  ...
  const onBtnPointerDown = endpoint_default.useCallback((event) => {
    event.preventDefault();
  }, []);
  const _onPointerDown = endpoint_default.useCallback((event) => {
    isMiddleMouseButton.current = event.button === 1;
    onPointerDown === null || onPointerDown === void 0 ? void 0 : onPointerDown(event);
  }, [
    onPointerDown
  ]);
  const _onPointerUp = endpoint_default.useCallback((event) => {
  ...
  const _onPointerLeave = endpoint_default.useCallback((event) => {
    isMiddleMouseButton.current = false;
    onPointerLeave === null || onPointerLeave === void 0 ? void 0 : onPointerLeave(event);
  }, [
    onPointerLeave
  ]);
  return endpoint_default.createElement("div", Object.assign({
  ...
  }), endpoint_default.createElement("span", {
    className: "dv-default-tab-content"
  }, title), !hideClose && endpoint_default.createElement("div", {
    className: "dv-default-tab-action",
    onPointerDown: onBtnPointerDown,
    onClick: onClose
  }, endpoint_default.createElement(CloseButton, null)));
};
...
var SplitviewReact = endpoint_default.forwardRef((props, ref) => {
  const domRef = endpoint_default.useRef(null);
  const splitviewRef = endpoint_default.useRef();
  const [portals, addPortal] = usePortalsLifecycle();
  endpoint_default.useImperativeHandle(ref, () => domRef.current, []);
  const prevProps = endpoint_default.useRef({});
  endpoint_default.useEffect(() => {
...
var GridviewReact = endpoint_default.forwardRef((props, ref) => {
  const domRef = endpoint_default.useRef(null);
  const gridviewRef = endpoint_default.useRef();
  const [portals, addPortal] = usePortalsLifecycle();
  endpoint_default.useImperativeHandle(ref, () => domRef.current, []);
  const prevProps = endpoint_default.useRef({});
  endpoint_default.useEffect(() => {
...
var PaneviewReact = endpoint_default.forwardRef((props, ref) => {
  const domRef = endpoint_default.useRef(null);
  const paneviewRef = endpoint_default.useRef();
  const [portals, addPortal] = usePortalsLifecycle();
  endpoint_default.useImperativeHandle(ref, () => domRef.current, []);
  const prevProps = endpoint_default.useRef({});
  endpoint_default.useEffect(() => {
